...
// ── loadCalibration ───────────────────────────────────────────────────────
//
// Threshold derivation — all as multiples of baseline so they scale
// automatically across machines:
//
//   IDLE_UTIL_MAX      = max(15,  baseline_util  * 3.0)
//                        A machine idling at 5% → threshold 15%
//                        A machine idling at 2% → threshold 15% (floor)
//
//   COMPUTE_CTXSW_MAX  = baseline_ctxsw * 2.5
//                        If idle ctxsw is 8000/s, compute threshold = 20000
//                        Stress-ng on that machine stays below this
//
//   LC_CTXSW_MIN       = baseline_ctxsw * 4.0
//                        Gaming / RT threads push well above this
//
//   LC_VARIANCE_MIN    = max(150, baseline_util * 25)
//                        Scales with how bursty the idle baseline already is
//
//   COMPUTE_IPC_MIN    stays fixed at 0.5 — IPC is workload-dependent,
